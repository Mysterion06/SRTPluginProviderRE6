...
{
    public class SRTPluginProviderRE6 : IPluginProvider
    {
        private Process process;
        private GameMemoryRE6Scanner gameMemoryScanner;
        ...
        public int Startup(IPluginHostDelegates hostDelegates)
        {
            ...
            process = GetProcess();
            gameMemoryScanner = new GameMemoryRE6Scanner(process);
        ...
        private Process GetProcess() => Process.GetProcessesByName("BH6")?.FirstOrDefault();
    }
}
